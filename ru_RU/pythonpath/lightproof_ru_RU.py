...
['(?u)(?<![-\\w\\u2013.,\\u00AD])[.]{3}(?![-\\w\\u2013\\u00AD])', '…', 'Символ троеточия.', 'option(LOCALE,"typographica")', 0],
...
["(?u)(?<![-\\w\\u2013.,\\u00AD])(?iu)(?P<Abc_1>[a-zA-Zа-яА-Я][a-zA-Zа-яА-Я]+)'(?P<w_1>\\w*)(?![-\\w\\u2013\\u00AD])", '\\g<Abc_1>’\\g<w_1>', 'Апостроф.', 'option(LOCALE,"quotation")', 0],
